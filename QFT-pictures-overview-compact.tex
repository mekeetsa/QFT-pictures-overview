...
\node [anchor=north, color=black] at (0,17.5) {
	\sf by M.B.Kocic ~--~ Version 1.0.3 (2016-01-11)
};

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% S.P.

\draw [dashed,color=red!30] (-11.5,0.1) -- (11.5,0.1);
\draw [thick][-triangle 45] (7,2.6) -- (-6.75,2.6);
\draw [thick][-triangle 45] plot[smooth, tension=.7] coordinates {(-2,-4.4) (-6,-2.4) (-7.98,1.76)};
\draw [thick][-triangle 45] plot[smooth, tension=.7] coordinates {(8,2.1) (6,-2.4) (2.25,-4.4)};
\draw [color=black!30!green][-triangle 45] (-2.5,0.1) -- (-4.75,-1.65);
\draw [color=black!30!red][-triangle 45] (2.5,0.1) -- (4.75,-1.65);
\draw [color=black!30!green][-triangle 45] (-5,-1.9) -- (-8.59,-4.35);
\draw [color=black!30!red][-triangle 45] (5,-1.9) -- (8.59,-4.35);


\node [boxed,fill=white,rounded corners=3mm,minimum height=2cm] at (-9,3.1) {
...
\node [boxed,SP,rounded corners=3mm] at (-9,4.2) {
	\begin{minipage}{4cm}\center\bf
		Schr\"odinger\\Picture
	\end{minipage}
};

\node [boxed,SP,minimum height=12mm] at (0,2.6) {
...
\node [anchor=north west,text width=150mm] at (-21.5,17.5) {
...
\node [boxed,SP,anchor=north,inner sep=3mm] at (-20,15) {
	\begin{minipage}{80mm}
...
\node [boxed,anchor=north,inner sep=3mm] at (-20,11.9) {
	\begin{minipage}{80mm}
...
\node [boxed,anchor=north,inner sep=3mm] at (-20,9.9) {
	\begin{minipage}{80mm}
...
\node [boxed,anchor=north,inner sep=3mm] at (-11,15) {
	\begin{minipage}{80mm}
...
\node [boxed,anchor=north,inner sep=3mm] at (-11,11.9) {
	\begin{minipage}{80mm}
...
\node [shape=circle,draw,SP,inner sep=2pt] at (-7.2,13.5) {\large\textbf{1}};
\node [shape=circle,draw,SP,inner sep=2pt] at (-7.2,10.1) {\large\textbf{2}};

\node [boxed,anchor=north,inner sep=3mm] at (-10,8.8) {
	\begin{minipage}{80mm}
...
\node [boxed,anchor=north,inner sep=3mm] at (-19,6.5) {
...
\draw [-triangle 45,ultra thick] (-15,9) -- (-15,6.5);
...
\node [boxed,HP,rounded corners=3mm] at (9,4.2) {
	\begin{minipage}{4cm}\center\bf
		Hesienberg\\Picture
	\end{minipage}
};

\node [anchor=north west,text width=150mm] at (8.5,17.5) {
...
%\node [anchor=north] at (0,17.5) {
%	\color{red}\textbf{In QFT we use the Heisenberg picture!}
%};

%\draw [red][-triangle 45,ultra thick] (-0.5888,16.7008) -- (0.4112,16.7008);
...
\node [boxed,anchor=north,inner sep=3mm] at (9,12) {
	\begin{minipage}{80mm}
...
\node [boxed,anchor=north,inner sep=3mm] at (9,8) {
	\begin{minipage}{80mm}
...
\node [boxed,anchor=north,inner sep=3mm] at (19,15) {
	\begin{minipage}{100mm}
		...
		\begin{gather}
			...
			\nonumber \phi(\mathbf{x},t)^\HP = 
				...
				\Big).
		\end{gather}
		Alternatively, we can find $\phi^\HP(x)$ directly from, \vspace{-1mm}
		\begin{align}
			\nonumber \phi(\mathbf{x},t)^\HP = \ee^{\ii H t} \, \phi(\mathbf{x})^\SP \, \ee^{-\ii H t} ,
		\end{align}
...
\node [boxed,fill=white,rounded corners=3mm,minimum height=2cm] at (0,-4) {
...
\node [boxed,IP,rounded corners=3mm] at (0,-2.9) {
	\begin{minipage}{4cm}\center\bf
		Interaction\\Picture
	\end{minipage}
};

\node [boxed,HP,minimum height=12mm] at (-6.5,-2.4) {
	\begin{minipage}{30mm}\center\large
		$ \mathcal{U}_0(t,t_0) $
	\end{minipage}
};

\node [boxed,SP,minimum height=12mm] at (6.5,-2.4) {
	\begin{minipage}{30mm}\center\large
...
\node at (6.9598,-0.2342) { $\times$ };
\node at (4.0032,-3.456) { $=$ };
\node at (-3.7513,-3.4897) { $\times$ };
\node at (-6.9835,-0.3716) { $=$ };
\node at (4.4361,2.9053) { $\times$ };
\node at (-4.0999,2.9275) { $=$ };
...
\node [boxed,HP,anchor=north,inner sep=3mm] at (-9,-4.4) {
	\begin{minipage}{80mm}
...
\node [boxed,SP,anchor=north,inner sep=3mm] at (9,-4.4) {
	\begin{minipage}{80mm}
...
\node [anchor=south] at (0,-6.8) {\bf
	Covariance between S.P., I.P. and H.P.
};

\node [boxed,anchor=north,inner sep=3mm] at (0,-6.8) {
	\begin{minipage}{80mm}
		For states: \vspace{-1mm}
		\begin{align}
...
\node [boxed,IP,anchor=north,inner sep=3mm] at (9,-7.9) {
	\begin{minipage}{80mm}
		\begin{center}
...
\node [boxed,anchor=north,text width=80mm,text justified,inner sep=3mm] at (-9,-7.9) {
...
%\node [boxed,anchor=north,text width=100mm,text justified,inner sep=3mm] at (19,-5.75) {
...
\node [boxed,anchor=north,text width=100mm,text justified,inner sep=3mm] at (19,-4.95) {
...
\node [red,anchor=south,rotate=45] at (12.0565,1.6149) {\bf
	The full-theory is here.
};

\draw  [red,-triangle 45] plot[smooth, tension=.7] coordinates {(11.5,2.1) (13,4.1) (11.5,3.6)};

\node [red,anchor=south,rotate=45] at (-12.8698,-4.0302) {\bf
	The free-theory is here.
};

\draw  [red,-triangle 45] plot[smooth, tension=.7] coordinates {(-12.4832,-3.5491) (-14.1704,-5.4471) (-13.5,-5.9)};

\node [red,anchor=south,rotate=45] at (12.965,-2.7382) {\bf
	Perturbations are here.
};

\draw  [red,-triangle 45] plot[smooth, tension=.7] coordinates {(12.5432,-3.3005) (13.2813,-2.9139) (13.0352,-4.2144)};


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% S-matrix

\node [boxed,fill=blue!2,anchor=north,inner sep=3mm] at (-19,-6.4) {
	\begin{minipage}{100mm}
...
\node [boxed,fill=cyan!2,anchor=north,inner sep=3mm] at (-19,-8.4) {
	\begin{minipage}{100mm}
